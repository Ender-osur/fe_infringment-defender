...
<template>
  <div class="p-4 max-w-5xl mx-auto space-y-6">
    ...
    <div v-if="!showForm" class="flex justify-center mb-6">
      <button
        @click="handleCreateQuestion"
        class="px-5 py-2.5 bg-osur-dark dark:bg-osur text-white dark:text-dark rounded-lg hover:opacity-90 transition-colors font-medium flex items-center gap-2"
      >
