...
const messages = {
  en: {
    ...
    messages: {
      ...
      credentialsInvalid: 'Invalid credentials. Please verify your email and password.',
      serverError: 'Server error. Please try again later.',
      networkError: 'Network error. Please check your internet connection.',
      registerSuccess: 'Registration successful! Please check your email to verify your account.',
      registerFailed: 'Registration failed. Please try again with different information.',
      registrationServerError: 'Server error during registration. Please try again later.',
      registrationNetworkError: 'Network error during registration. Please check your internet connection.',
  ...
  es: {
    ...
    messages: {
      ...
      loginFailed: 'Error al iniciar sesión. Por favor, verifica tu correo y contraseña e inténtalo de nuevo.',
      credentialsInvalid: 'Credenciales inválidas. Por favor, verifica tu correo y contraseña.',
      ...
      registerFailed: 'Error al registrarse. Por favor, inténtalo de nuevo con información diferente.',
      registrationServerError: 'Error del servidor durante el registro. Por favor, inténtalo más tarde.',
      registrationNetworkError: 'Error de red durante el registro. Por favor, verifica tu conexión a internet.',
